...
import calnet.fit_calnet_ori_with_bidi_optogenetics as fcowo
import sys
import pyute as ut
...
if __name__=="__main__":
    ...
    for itry in range(ntries):
        fcowo.fit_weights_and_save(weights_files[itry],ca_data_file=ca_data_file,opto_silencing_data_file=opto_silencing_data_file,opto_activation_data_file=opto_activation_data_file,allow_var=False,fit_s02=True,constrain_isn=True,l2_penalty=0.1,init_noise=0.1,init_W_from_lsq=True,scale_init_by=1,init_W_from_file=True,init_file=init_files[itry])
