...
calnet_base = '/Users/dan/calnet_data/'
Niter = int(1e3)
...
def build_models_and_simulate_opto_effects(weights_files,target_file,sim_options=sim_options,pool_size=1):
    ...
    keys = ['YY_opto','YY_opto_tavg_no_pcsst','YY_opto_tavg_no_vipbias']
...
def run(fit_lbl,calnet_base=calnet_base,sim_options=sim_options,pool_size=1,lcutoff=10):
    ...
    target_file = calnet_base + 'dynamics/vip_halo_l4_opto_tavg_connection_adjustment_%s.npy'%fit_lbl
