...
if __name__=="__main__":
    ...
    if len(sys.argv)>4:
        weights_files_file = str(sys.argv[4])
    else:
        weights_files_file = None
    ...
    if not weights_files_file is None:
   ...
   #     weights_files = weights_files + [calnet_data_fold+'weights/'+weight_base+'/%03d.npy'%itr for itr in range(ntries*irep,ntries*(irep+1))]
    ...
    for irep in range(nreps):
        ...
        weights_files = weights_files + [calnet_data_fold+'weights/'+weight_base+'/%03d.npy'%itr for itr in these_fit_nos]
