...
def run(fit_lbl,calnet_base=calnet_base,sim_options=sim_options,pool_size=1,target_prefix='pc_opto_tavg_some_mild',lcutoff=10):
...
def run_one_and_both(pool_size,indicator,calnet_base=calnet_base):
    ...
    run(fit_lbl,pool_size=pool_size,calnet_base=calnet_base,sim_options=sim_options,target_prefix='pc_both_pixels_opto_tavg_some_mild')
    if indicator:
        sim_options['both_pixels'] = False
        run(fit_lbl,pool_size=pool_size,calnet_base=calnet_base,sim_options=sim_options,target_prefix='pc_one_pixel_opto_tavg_some_mild')
